import { mysqlTable, varchar, text, double, int, datetime, mysqlEnum, boolean, json, uniqueIndex } from 'drizzle-orm/mysql-core';
...
export const teacherComments = mysqlTable('teacher_comments', {
  ...
  class_teacher_signature: text('class_teacher_signature'),
