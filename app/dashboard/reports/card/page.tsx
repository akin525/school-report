                      ...
                      {subjectCumulative.map((row: any, idx: number) => {
                        ...
                        return (
                          <tr key={row.subjectId} style={{ background: idx % 2 === 0 ? '#ffffff' : '#fef9f9', borderBottom: '1px solid #fee2e2' }}>
                            ...
                            <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', color: '#1e1e1e' }}>{ta?.total !== null ? ta?.total : ''}</td>
                            <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontSize: '7px', color: '#6b7280' }}>{ta?.total !== null && ta?.class_average !== undefined && ta?.class_average !== null ? Number(ta.class_average).toFixed(1) : ''}</td>
                            <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontSize: '7px' }}>{ta?.total !== null && ta?.position ? ordinal(ta.position) : ''}</td>
                            <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', color: (ta && ta.total !== null) ? getGradeColor(ta.grade) : '#374151' }}>{ta?.total !== null ? ta?.grade : ''}</td>
                            
                            {format === 'cumulative' && (
                              <>
                                {/* 2nd Term */}
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', color: '#374151' }}>{(termParam >= 2 && t2 && t2.total !== null) ? ((t2.ca1_score || 0) + (t2.ca2_score || 0) || '0') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', color: '#374151' }}>{(termParam >= 2 && t2 && t2.total !== null) ? (t2.exam_score || '0') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', color: '#1e1e1e' }}>{(termParam >= 2 && t2 && t2.total !== null) ? (t2.total || '0') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontSize: '7px', color: '#6b7280' }}>{(termParam >= 2 && t2 && t2.total !== null) ? (t2.class_average !== undefined && t2.class_average !== null ? Number(t2.class_average).toFixed(1) : '') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontSize: '7px' }}>{(termParam >= 2 && t2 && t2.total !== null) ? (t2.position ? ordinal(t2.position) : '') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', color: (t2 && t2.total !== null) ? getGradeColor(t2.grade) : '#374151' }}>{(termParam >= 2 && t2 && t2.total !== null) ? (t2.grade || '') : ''}</td>
                                {/* Cum 1+2 */}
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', background: '#f0fdf4', color: '#166534' }}>{(termParam >= 2 && (t1 || t2) && row.cum12Total !== null) ? row.cum12Ave : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', background: '#f0fdf4', color: '#166534' }}>{(termParam >= 2 && (t1 || t2) && row.cum12Total !== null) ? row.class12Ave : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', background: '#f0fdf4', color: (termParam >= 2 && (t1 || t2) && row.cum12Total !== null) ? getGradeColor(row.cum12Grade) : '#374151' }}>{(termParam >= 2 && (t1 || t2) && row.cum12Total !== null) ? row.cum12Grade : ''}</td>
                                {/* 3rd Term */}
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', color: '#374151' }}>{(termParam >= 3 && t3 && t3.total !== null) ? ((t3.ca1_score || 0) + (t3.ca2_score || 0) || '0') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', color: '#374151' }}>{(termParam >= 3 && t3 && t3.total !== null) ? (t3.exam_score || '0') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', color: '#1e1e1e' }}>{(termParam >= 3 && t3 && t3.total !== null) ? (t3.total || '0') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontSize: '7px', color: '#6b7280' }}>{(termParam >= 3 && t3 && t3.total !== null) ? (t3.class_average !== undefined && t3.class_average !== null ? Number(t3.class_average).toFixed(1) : '') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontSize: '7px' }}>{(termParam >= 3 && t3 && t3.total !== null) ? (t3.position ? ordinal(t3.position) : '') : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', color: (t3 && t3.total !== null) ? getGradeColor(t3.grade) : '#374151' }}>{(termParam >= 3 && t3 && t3.total !== null) ? (t3.grade || '') : ''}</td>
                                {/* Final Cumulative */}
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', background: '#f0fdf4', color: '#166534' }}>{(termParam >= 3 && hasData && row.cumTotal !== null) ? row.cumAve : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', background: '#f0fdf4', color: '#166534' }}>{(termParam >= 3 && hasData && row.cumTotal !== null) ? row.classFinalAve : ''}</td>
                                <td style={{ padding: '1px 2px', textAlign: 'center', border: '1px solid #fca5a5', fontWeight: 'bold', background: '#f0fdf4', color: (termParam >= 3 && hasData && row.cumTotal !== null) ? getGradeColor(row.cumGrade) : '#374151' }}>{(termParam >= 3 && hasData && row.cumTotal !== null) ? row.cumGrade : ''}</td>
                              </>
                            )}
                          </tr>
                        );
